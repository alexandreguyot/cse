...
class RoleUserTableSeeder extends Seeder
{
    public function run()
    {
        ...
        User::findOrFail(9)->roles()->sync(1);
        User::findOrFail(10)->roles()->sync(1);
        User::findOrFail(11)->roles()->sync(1);
        User::findOrFail(12)->roles()->sync(1);
        User::findOrFail(13)->roles()->sync(1);
        User::findOrFail(14)->roles()->sync(1);
    }
}
